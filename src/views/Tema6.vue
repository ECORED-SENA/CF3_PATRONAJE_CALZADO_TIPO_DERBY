...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
              ...
              .col-lg-6.espacio___movil_3(data-aos="zoom-in")
                .estilo___caja_16.h-100
                  .row.justify-content-center.mb-3
                    .col-7
                      figure.mb-4.d-none.d-xl-block
                        img(src='@/assets/curso/temas/img86.svg', alt="" style="max-width: 90px").m-auto
                    h3 Molde de forro del talón con aumento para costura
                    p.mb-0 Este molde se construye siguiendo las instrucciones descritas para el forro del talón, añadiendo el aumento correspondiente para la costura, según el tipo de unión elegida (cosido y vuelto o zigzag).
    ...
    p.mb-4.espacio___movil_1 Finalmente, dibuje la línea de la puntera entre estas dos referencias. Inicie en el punto máximo sobre la capellada y finalice en el punto inferior sobre la línea de plantilla, cuidando que la forma sea coherente con el diseño y proporciones del modelo.
    ...
    .caja-titulos-tercer-nivel.mb-5(data-aos="fade-right")
      .col-lg-auto
        figure
          img(src="@/assets/curso/temas/img4.svg" style="max-width: 60px").m-auto
      .col
        h3 Construcción talón

    p.mb-4.espacio___movil_1 Desde el punto de altura del talón, mida 20 mm hacia adelante sobre la línea de profundidad. Este nuevo punto se denomina cabeza del talón. Desde allí, trace una línea perpendicular hacia la línea de plantilla; este trazo definirá el cuello del talón.

    .fondo_color_15
      .px-5
        .row.align-items-center.mb-5.justify-content-center
          .col-lg-10
            .row.align-items-center.estilo___caja_17(data-aos="zoom-in")
              .col-xl-auto
                figure.d-none.d-xl-block
              ...
              .col-xl
                ...
                <ul class="fa-ul">
                  ...
                  <li class="mb-0"><span class="fa-li"><i class="fas fa-cut"></i></span>Finalmente, ajuste las curvas del talón uniendo los vértices formados durante la construcción, hasta obtener la forma deseada.</li>
                </ul>
    ...
    .fondo_color_16
      .px-5
        ...
        p.mb-4.espacio___movil_1 En caso de que se presenten cruces entre las piezas del molde, estas deben ajustarse cuidadosamente para evitar superposiciones innecesarias. Este tipo de interferencias no solo complica el proceso de armado del calzado, sino que también puede provocar incomodidades para el usuario final. Por esta razón, es fundamental asegurar un diseño limpio y funcional que favorezca tanto la calidad como el confort del producto.
    ...
    .fondo_color_17
      .px-5
        p.mb-4.espacio___movil_1 Tome una cartulina con eje, como se realizó en el modelo anterior, y dóblela por la línea central. Posicione el patrón de manera que el eje de la cartulina coincida con el eje de la puntera y trace su contorno. Si el diseño requiere doblez, añada un aumento de 5 mm para calzado de hombre o 4 mm para calzado de dama o niño en la parte superior de la puntera. Si no es necesario, omita este paso. Recorte la forma trazada para obtener el molde de la puntera.
        ...
        p.mb-4.espacio___movil_1 Ubique el patrón sobre una cartulina, asegurándose de que la línea recta o eje de la talonera coincida con el eje de la cartulina. Luego, trace la silueta de la talonera. Agregue un aumento de 5 mm para doblez si la pieza lo requiere y un aumento de 2 mm para la costura de cierre del talón. Recorte el contorno para extraer el molde del talón.
    ...
    .bloque-texto-g.color-acento-contenido.p-3.p-sm-4.p-md-5.mb-5.espacio___movil_1(data-aos="fade-up")
      .bloque-texto-g__img(
    ...
    .fondo_color_18
      .px-5
        ...
        .row.mb-5.m-0.espacio___movil_1(data-aos="fade-right")
            ...
            .row.align-items-center.m-0(data-aos="zoom-in")
              .col-xl.estilo___caja_19
                ...
                <ul class="fa-ul">
                  ...
                  <li class="mb-0"><span class="fa-li"><i class="fas fa-cut"></i></span>Dibuje la parte delantera del forro y suavice la línea que une ambas secciones para lograr una transición uniforme.</li>
                </ul>
              .col-xl-auto
                figure.d-none.d-xl-block
