...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
          ...
          .col-lg-3.espacio___movil_3(data-aos="zoom-in")
            .estilo___caja_15.h-100
              .row.justify-content-center.mb-3
                ...
                h3 Bigotera
                p.mb-0 Es una pieza adicional que se superpone a la capellada en la parte delantera, generalmente desde la puntera hasta la zona media del calzado.
          .col-lg-3.espacio___movil_3(data-aos="zoom-in")
            .estilo___caja_15.h-100
              .row.justify-content-center.mb-3
                .col-7
                ...
                h3 Costuras visibles
                p.mb-0 Puede incluir costuras decorativas, lo que otorga un acabado más artesanal o elegante, dependiendo del diseño.
          .col-lg-3.espacio___movil_3(data-aos="zoom-in")
            .estilo___caja_15.h-100
              .row.justify-content-center.mb-3
                .col-7
                ...
                h3 Detalles decorativos
                p.mb-0 Pueden incorporarse perforaciones (brogueado) o grabados para aportar mayor sofisticación al modelo.
    ...
    .caja-titulos-tercer-nivel.mb-5(data-aos="fade-right")
      ...
      .col
        h3 Trazado de la bigotera a partir del punto máximo de la puntera

    p.mb-4.espacio___movil_1 Este trazado permite definir una pieza simétrica, proporcionada y funcional, que se integrará adecuadamente con el resto de los componentes del modelo.
