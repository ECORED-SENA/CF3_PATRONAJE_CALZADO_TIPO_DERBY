export default {
      ...
      },
      {
        ...
        subMenu: [
          ...
          },
          {
            numero: '7.3',
            titulo:
              'Moldes forro para el modelo tipo <em>Derby</em> con Bigotera',
            hash: 't_7_3',
          },
        ],
      },
  ...
  glosario: [
    ...
    },
    {
      termino: 'Textil',
      significado:
        'material compuesto por fibras naturales (algodón, lino, lana) o sintéticas (poliéster, <em>nylon</em>) que se utiliza en la fabricación de calzado, especialmente en modelos deportivos y casuales, debido a su ligereza y transpirabilidad.',
    },
    {
      termino: 'Horma',
      significado:
  ...
  referencias: [
    {
      referencia:
        'Arias Navarro, A., y Acevedo Ramírez, G. (1998). Patronaje, modelado y escalado de calzado.',
      link: '',
    },
    {
      referencia:
    ...
    {
      referencia:
        'Motawi, W. M., y Motawi, A. M. (2021). Patronaje de calzado y diseño de hormas. Wade Motawi.',
      link: '',
    },
    {
      referencia:
        'Vass, L., y  Molnár, M. (1999). Zapatos de caballero hechos a mano. Konemann.',
      link: '',
    },
    {
      referencia:
